...
def extract():
    ...
    csv_file_path = '/Users/tuphanhoang/Workspace/Big_Data/data/my_csv_file.csv'
...
def transform():
    in_csv_file_path = '/Users/tuphanhoang/Workspace/Big_Data/my_csv_file.csv'
    out_csv_file_path = '/Users/tuphanhoang/Workspace/Big_Data/my_csv_file_square.csv'
...
def email():
    ...
    import base64
    message = Mail(
        from_email='phtu.hazard@gmail.com',
        to_emails='hoangtubktphcm@gmail.com;22210028@ms.uit.edu.vn',
